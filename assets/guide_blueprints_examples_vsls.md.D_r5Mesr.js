import{_ as i,o as a,c as n,ag as l}from"./chunks/framework.yGqRar0R.js";const o=JSON.parse('{"title":"vSLS","description":"","frontmatter":{},"headers":[],"relativePath":"guide/blueprints/examples/vsls.md","filePath":"guide/blueprints/examples/vsls.md"}'),t={name:"guide/blueprints/examples/vsls.md"};function p(e,s,h,k,r,E){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="vsls" tabindex="-1">vSLS <a class="header-anchor" href="#vsls" aria-label="Permalink to &quot;vSLS&quot;">​</a></h1><p>Uses the vSLS plugin annotations for on-join commands and matchmaking. For a field-by-field reference, see <a href="./../../vsls/configuring.html#annotations-vsls">Configuring vSLS</a>.</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">      maxPlayers</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1</span></span></code></pre></div>`,3)])])}const g=i(t,[["render",p]]);export{o as __pageData,g as default};
